...
### 패치 내역 요약 (2025-06-15~2025-06-16)

| 날짜 | 주요 변경 요약 |
| --- | --- |
| 2025-06-15 | i18n 및 기능 개선: 한국어/영어 라우팅 구조, GitHub 통계 안내 개선, PDF 이력서 업데이트, 주요 컴포넌트 테스트 확대 |
...
- 2025-08-29 (Codex) - 패치 내역 요약 테이블 추가
  - README에 2025-06-15~2025-06-16 변경 사항을 한눈에 볼 수 있는 표를 추가
  - Codex 기준 위반 없음
